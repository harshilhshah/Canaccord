...
def obalon_new():
	...
	for city in soup.find_all('div',{'class':'slp_directory_entry'}):
		...
		for office in office_arr:
			...
			big_data.append([doc_name,doc_practice,city,doc_location,date])
