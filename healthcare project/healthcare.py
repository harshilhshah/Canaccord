...
procedureToColMapStryker = { "Knee": 'E', "Partial Knee": 'F', "Robotic-arm assisted partial knee": 'G', "Hip": 'H',
		"Robotic-arm Assisted hip": 'I', "Mobile bearing hip": 'J', "Direct anterior approach": 'K', "Partial knee replacement": 'F',
		"Direct superior approach": 'L', "Ankle": 'M', "STAR ankle replacement": 'N', "Ankle Arthritis": 'O', "Foot": 'P',
		"Foot Arthritis": 'Q', "Flatfoot": 'R', "Bunion": 'S', "Hammertoe": 'T', "Charcot": 'U', "Sports Injuries": 'V',
		"Robotic-arm assisted total knee": 'W'}
procedureToColMapSmithAndNephew = {"VERILAST Knee": 'E', "VERILAST Hip": 'F', "JOURNEY II Active Knee System": 'G',
		"Partial Knee Replacement":'H', "Navio Robotics-Assisted Surgical System": 'I', "VISIONAIRE - Patient Matched Technology": 'J', 
		"Direct Anterior Approach Hip Replacement": 'K', "BIRMINGHAM HIP Resurfacing": 'L'}
...
def smithAndNephew():
	...
	for i,sheetname in enumerate(get_zipcodes(aggregate)):
		big_data = []
		names = []
		procedureIds = ['24', '27', '28', '22', '36', '23', '25', '11']
		zipcode = sheetname.split('-')[1].strip()
		print zipcode
